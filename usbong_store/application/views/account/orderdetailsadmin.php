						...
						echo '<div class="Order-details-purchased-datetime-stamp">'.$addedDateTimeStamp.'</div>';
							...
							//					echo count($order_details).'items';
								...
								if (count($order_details)==0) {
									...
									echo '<a class="Order-details-order-number-link" href="'.site_url('account/ordersummaryadmin/0').'/'.$value['customer_id'].'">';
										echo '<span class="Fulfilled-Status-Not-OK">&ensp;Not Yet&ensp;</span>';
									echo '</a>';
									echo '<a class="Order-details-order-number-link" href="'.site_url('account/ordersummaryadmin/1').'/'.$value['customer_id'].'">';
