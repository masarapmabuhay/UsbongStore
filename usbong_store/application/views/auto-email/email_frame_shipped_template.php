...
<body style="margin:0; padding:0; background-color:#FFFFFF;">
    ...
    <div style="display:none;font-size:1px;color:#333333;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">
        Hi <?php echo $customer['customer_first_name'].', '.$email->data_02;?>
    </div>
    ...
    <center>
        <div style="background-color:#F2F2F2; max-width: 640px; margin: auto;">
            ...
            <!-- Call to Action: 1 Col x 1 Row Grid -->
            <table width="640" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:640px; width:100%;" bgcolor="#FFFFFF">
                <tr>
                    <td align="center" valign="top" style="padding:10px;">
                        <table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:600px; width:100%;">
                            <tr>
                                <td align="center" valign="top" style="<?php echo ''; ?>">
                                    <a href="<?php echo $email->data_04; ?>" title="<?php echo $email->data_03;?>" style="<?php echo $inline_call_to_action_style;; ?>">
                                        <?php echo $email->data_03; ?>
                                    </a>
                                </td>
                            </tr>
                        </table>
			...
			<!-- Engagement Image: 1 Col x 1 Row Grid -->
            <table width="640" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:640px; width:100%;" bgcolor="#FFFFFF">
                <tr>
                    <td align="center" valign="top" style="padding:10px;">
                        <table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="max-width:600px; width:100%;">
                            <tr>
                                <td align="center" valign="top" style="<?php echo ''; ?>">
                                    <a href="<?php echo $email->data_04;?>" title="<?php echo '';?>">
                                        <img src="<?php echo base_url('assets/images/'.$email->data_02);?>" width="600" height="" style="margin:0; padding:0; border:none; display:block;" border="0" alt="<?php echo '';?>" />
                                    </a>
                                </td>
                            </tr>
                        </table>
