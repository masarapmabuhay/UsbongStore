...
START TRANSACTION;
USE `usbong_store`;
INSERT INTO `usbong_store`.`auto_email_template` (`auto_email_template_id`, `view`, `date_01_used`, `date_02_used`, `date_03_used`, `date_04_used`, `date_05_used`, `date_01_attribute`, `date_02_attribute`, `date_03_attribute`, `date_04_attribute`, `date_05_attribute`) VALUES (1, 'email_frame_simple_template', 1, 0, 0, 0, 0, 'Welcome Message', NULL, NULL, NULL, NULL);
