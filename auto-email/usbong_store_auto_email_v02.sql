...
START TRANSACTION;
USE `usbong_store`;
INSERT INTO `usbong_store`.`auto_email_template` (`auto_email_template_id`, `view`, `date_01_used`, `date_02_used`, `date_03_used`, `date_04_used`, `date_05_used`, `date_01_attribute`, `date_02_attribute`, `date_03_attribute`, `date_04_attribute`, `date_05_attribute`) VALUES (1, 'test_view', 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `usbong_store`;
INSERT INTO `usbong_store`.`auto_email` (`auto_email_id`, `subject`, `auto_email_template_id`, `datetime`, `data_01`, `data_02`, `data_03`, `data_04`, `data_05`) VALUES (1, 'test subject', 1, '2017-10-1 00:00:00', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `usbong_store`.`auto_email_product` (`auto_email_product_id`, `auto_email_id`, `product_id`) VALUES (10, 1, 129);
...
INSERT INTO `usbong_store`.`auto_email_setting` (`auto_email_setting_id`, `attribute`, `value`, `remarks`) VALUES (8, 'sender_alias', 'Mike from Usbong', 'A human name');
